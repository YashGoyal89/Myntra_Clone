...
exports.registermobile = A(async (req, res, next) => {
  ...
  let options = { authorization: process.env.YOUR_API_KEY, message: `This Website is made by Yash and Rohit Thank You to use our Website Your OTP: is ${otp}`, numbers: [phonenumber] }
...
exports.resendotp = A(async (req, res, next)=>{
  ...
  let options = { authorization: process.env.YOUR_API_KEY, message: `This website is made my Yash and Rohit Thank You to use our Website Your OTP: is ${otp}`, numbers: [req.params.id] }
